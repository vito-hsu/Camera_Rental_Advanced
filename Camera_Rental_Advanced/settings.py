"""
Django settings for Camera_Rental_Advanced project.
...
ROOT_URLCONF = 'Camera_Rental_Advanced.urls'
...
WSGI_APPLICATION = 'Camera_Rental_Advanced.wsgi.application'
